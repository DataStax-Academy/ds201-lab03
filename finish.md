      ...
      <div class="row g-4 py-2 row-cols-1 row-cols-lg-1">
        <div class="feature col div-choice">
          ...
          <div class="scenario-objectives">In this hands-on lab, you learned how to:</div>
            <ul>
              <li><span class="scenario-objective">Create a keyspace for KillrVideo</span></li>
              <li><span class="scenario-objective">Create a table to store video metadata</span></li>
              <li><span class="scenario-objective">Load the data for the video table from a CSV file</span></li>
            </ul>
        </div>
      </div>
    </div>
